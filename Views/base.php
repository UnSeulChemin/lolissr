...
<head>
    ...
    <title><?= $title; ?></title>
    <link rel="shortcut icon" type="image/png" href="<?= $basePath; ?>public/images/favicon/favicon.png">
    <link rel="stylesheet" type="text/css" href="<?= $basePath; ?>public/css/reset.css">
    <link rel="stylesheet" type="text/css" href="<?= $basePath; ?>public/css/app.css">
