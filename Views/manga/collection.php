<section class="section-content">
        ...
        <?php foreach($mangas as $manga): ?>
            <article class="card-content">
                <figure class="card-figure">
                    <a class="flex" href="<?= $routeRedirection; ?>manga/livre/<?= $manga->id ?>">
                        <img alt="<?= $manga->livre ?>" src="<?= $routeRedirection; ?>public/images/mangas/thumbnail/<?= $manga->thumbnail.".".$manga->extension ?>">
                    </a>
                </figure>
                <div>
    ...
    <nav class="flex-center-center-gap-25 m-t-30">
        ...
        for ($getId = 1; $getId <= $compteur; $getId++):
            if ($base != $getId): 
                ?><a class="link-paginate" href="<?= $routeRedirection; ?>manga/page/<?= $getId; ?>"><?= $getId; ?></a><?php
            else: 
