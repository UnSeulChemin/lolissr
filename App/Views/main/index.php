<section class="layout-container">
    ...
    <section class="home-grid home-grid-stats card-grid-3 animate-fade-up-stagger">
        ...
        <article class="card card-small">
            ...
            <p class="home-card-value"><?= (int) $totalTomes ?> tomes</p>
        </article>

        <article class="card card-small">
            <h2 class="home-card-title">📖 Total séries</h2>
            <p class="home-card-value"><?= (int) $totalSeries ?> séries</p>
        </article>
        ...
        <article class="card card-small">
            ...
            <p class="home-card-value">
                <?= $averageNote !== null
                    ? number_format((float) $averageNote, 1, ',', ' ') . '/10'
                    : 'Aucune note' ?>
            </p>
        </article>
    ...
    <section class="home-grid home-grid-stats card-grid-3 animate-fade-up-stagger">
        ...
        <article class="card card-small">
            ...
            <p class="home-card-value"><?= (int) $totalRead ?> lus</p>
        </article>

        <article class="card card-small">
            <h2 class="home-card-title">📚 Restants à lire</h2>
            <p class="home-card-value"><?= (int) $totalUnread ?> à lire</p>
        </article>
